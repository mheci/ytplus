// test_features.js — regression guard for v3.0.20.0 + v3.0.20.0 changes:
...
block("GEO WRAPPER CHAIN SAFETY (v3.0.20.0)", () => {
...
block("SPONSORBLOCK CACHE KEY (v3.0.20.0)", () => {
...
block("BFCACHE-SAFE LIFECYCLE (v3.0.20.0)", () => {
  ...
  ok("GM_info-less version fallback is current", /"3\.0\.20\.0"/.test(code));
});

block("CLIPBOARD SCREENSHOT (v3.0.20.0)", () => {
...
block("PER-CHANNEL SPEED MEMORY (v3.0.20.0)", () => {
...
block("JUMP TO HIGHLIGHT (v3.0.20.0)", () => {
...
block("IMPORT VALIDATION (v3.0.20.0)", () => {
