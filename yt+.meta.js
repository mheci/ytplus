...
// @version      3.0.18.6
// @description  YT+ makes your YouTube experience smoother, cleaner, and more enjoyable. v3.0.18.6: Audit fixes — Import settings menu command now wires to the real import; SB mute path now counts and accumulates time; ccTextColor and idleDimBlur are sanitized before CSS interpolation; update banner rebuilt with textContent. All 7 test suites pass. v3.0.18.5: SB privacy-mode fix. v3.0.18.4: _dm ReferenceError freeze fix. v3.0.18.3: Memory protection system. v3.0.18.2: _dm_active freeze fix. v3.0.18.1: Hotkey freeze fix. v3.0.18: Hotkeys everywhere + keyboard-friendly dashboard. v3.0.17: Update banner now opens the user.js file. v3.0.16: Data Minimization. v3.0.15: Hotfix. v3.0.14: Major SB expansion. v3.0.13: Update notif fix. v3.0.12: Dashboard perf fix.
// @author       YT+ Team
