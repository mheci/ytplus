...
(() => {
  ...
  function Je(e, t, a) {
    ...
    o.style.cssText =
      "max-width:520px;width:min(86%,520px);background:rgba(20,22,28,.55);border:1px solid rgba(255,255,255,.12);border-radius:16px;padding:24px 26px 20px;box-shadow:0 30px 80px rgba(0,0,0,.6),0 8px 24px rgba(0,0,0,.4);backdrop-filter:blur(24px) saturate(170%);-webkit-backdrop-filter:blur(24px) saturate(170%);display:flex;flex-direction:column;gap:16px;transform:translateY(8px);transition:transform .25s ease-out";
    const i = document.createElement("div");
  ...
  (xa.register({
    ...
    xa.register({
      ...
      apply(e) {
        ...
        let _ivsHotkey = S.inVideoSearchHotkey || "Ctrl+KeyF";
        const _ivsGet = () => {
          try {
