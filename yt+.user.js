...
// @connect      ytimg.com
// @connect      ggpht.com
// @icon         data:image/svg+xml;base64,
// @noframes
...
(() => {
          ...
          : setTimeout(() => {
              ...
              e &&
                ...
                (function (e, t) {
                  ...
                  ((i.style.cssText =
                    "width:64px;height:36px;border-radius:4px;background:#1a1a1a center/cover no-repeat;flex-shrink:0"),
                  ...
                  function p(e, t, a) {
                    ...
                    return (
                      ...
                      (n.textContent = e),
                      (n.style.cssText =
                        "appearance:none;border:0;border-radius:5px;padding:6px 12px;font:600 11px system-ui;cursor:pointer;" +
                        (t
                  ...
                  ((l.style.cssText = "display:flex;gap:6px;flex-shrink:0"),
                    l.appendChild(
                      p("Resume", !0, () => {
                        (t(), Ze());
                      }),
  ...
  function Je(e, t, a) {
    ...
    Ae = (function () {
      ...
      try {
        if (e)
          for (const t of ["playVideo", "playVideoAt"])
            "function" == typeof e[t] &&
              ((a[t] = e[t]), (e[t] = function () {}));
      } catch (e) {}
      try {
        t && !t.paused && t.pause();
      } catch (e) {}
      try {
        e && "function" == typeof e.pauseVideo && e.pauseVideo();
      } catch (e) {}
      return function () {
        try {
          if (e) for (const t of Object.keys(a)) e[t] = a[t];
        } catch (e) {}
      };
    })();
    ...
    ((r.id = "ytp-resume-overlay"),
      ...
      (r.style.cssText =
        'position:absolute;inset:0;z-index:2147483640;display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,rgba(0,0,0,.78) 0%,rgba(0,0,0,.92) 50%,rgba(0,0,0,.78) 100%);backdrop-filter:blur(8px) saturate(140%);-webkit-backdrop-filter:blur(8px) saturate(140%);font:14px/1.45 "YouTube Sans","Roboto",system-ui,-apple-system,sans-serif;color:#fff;opacity:0;transition:opacity .22s ease-out'));
    const o = document.createElement("div");
    o.style.cssText =
      "max-width:520px;width:min(86%,520px);background:#212121;border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:28px 28px 22px;box-shadow:0 30px 80px rgba(0,0,0,.6);display:flex;flex-direction:column;gap:18px;transform:translateY(8px);transition:transform .25s ease-out";
    const i = document.createElement("div");
    i.style.cssText = "display:flex;gap:14px;align-items:center";
    const d = document.createElement("div");
    ((d.style.cssText =
      "width:120px;height:68px;border-radius:8px;flex-shrink:0;background:#000 center/cover no-repeat;box-shadow:0 4px 12px rgba(0,0,0,.5);position:relative;overflow:hidden"),
      e.thumbnail &&
        (d.style.backgroundImage =
          "url('" + e.thumbnail.replace(/'/g, "%27") + "')"));
    const c = document.createElement("div");
    c.style.cssText =
    ...
    const s = document.createElement("div"),
      l = e.duration
        ...
        : 0;
    ((s.style.cssText =
      "height:100%;background:#ff0033;width:" + l.toFixed(1) + "%"),
      c.appendChild(s),
      d.appendChild(c),
      i.appendChild(d));
    ...
    ((u.style.cssText =
      "font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#aaa;font-weight:600"),
      (u.textContent = "Resume watching"));
    const h = document.createElement("div");
    ((h.style.cssText =
      "font-size:16px;font-weight:600;color:#fff;line-height:1.3;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden"),
      (h.textContent = e.title || e.videoId || "this video"));
    const m = document.createElement("div");
    m.style.cssText = "font-size:12px;color:#aaa";
    const y = ce(e.lastPosition || 0),
      g = e.duration ? ce(e.duration) : null;
    ((m.textContent =
      (e.channel ? e.channel + " · " : "") + (g ? y + " / " + g : "from " + y)),
      p.appendChild(u),
      p.appendChild(h),
      p.appendChild(m),
      i.appendChild(p),
    ...
    ((f.style.cssText = "font-size:14px;color:#e8e8e8;line-height:1.5"),
      (f.textContent =
    ...
    function v(e, t, a, n) {
      ...
      ((r.type = "button"),
        (r.style.cssText =
          "appearance:none;border:0;cursor:pointer;flex:1;min-width:140px;padding:12px 18px;border-radius:24px;font:600 14px/1.2 inherit;display:flex;flex-direction:column;align-items:center;gap:2px;" +
          (t
            ? "background:#fff;color:#0f0f0f"
            : "background:rgba(255,255,255,.1);color:#fff;border:1px solid rgba(255,255,255,.1)")));
      const o = document.createElement("span");
      if (((o.textContent = e), r.appendChild(o), a)) {
    ...
    b.style.cssText = "display:flex;gap:10px;flex-wrap:wrap;margin-top:4px";
    const k = v("Resume from " + y, !0, "Continue where you left off", () => {
        Qe();
        try {
          t && t();
        } catch (e) {}
      }),
      x = v("Start over", !1, "Play from the beginning", () => {
        Qe();
        try {
          a && a();
        } catch (e) {}
      });
    (b.appendChild(k), b.appendChild(x), o.appendChild(b));
    const w = document.createElement("div");
    w.style.cssText =
      "display:flex;justify-content:space-between;align-items:center;font-size:11px;color:#888;margin-top:2px";
    const C = document.createElement("span");
    C.textContent = "YT+ Session History";
    const S = document.createElement("button");
    ((S.type = "button"),
      (S.style.cssText =
        "background:none;border:0;color:#888;cursor:pointer;font:inherit;text-decoration:underline"),
      (S.textContent = "Dismiss"),
    ...
    (n.appendChild(r),
      ...
      requestAnimationFrame(() => {
        Me && ((Me.style.opacity = "1"), (o.style.transform = "translateY(0)"));
      }));
    try {
      k.focus();
    } catch (e) {}
    ...
    try {
      ((Le = new MutationObserver(() => {
        if (Me && !document.body.contains(Me)) {
          const e =
            document.querySelector("#movie_player") ||
            document.querySelector(".html5-video-player");
          e && e.appendChild(Me);
  ...
  (xa.register({
    ...
    settings(e) {
      (e.appendChild(Ro("Preferred language", "forceCCLang", Ba(!0))),
        ...
        e.appendChild(_o("Font family", "ccFontFamily")),
        e.appendChild(
        ...
        e.appendChild(_o("Text color", "ccTextColor")),
        e.appendChild(_o("Background color", "ccBgColor")),
        e.appendChild(
    ...
    xa.register({
      ...
      keys: ["sessionRestoreOn", "sessionResumeMode"],
      apply(e) {
      ...
      ((an = !0),
        ...
        (function (e) {
          ...
          ((a.style.cssText =
            ...
            (a.innerHTML =
              '<span style="font-size:18px;color:var(--yt-spec-call-to-action,#3ea6ff)">✓</span><span class="ytp-fcw-title" style="flex:1;font-weight:600">Marking as watched</span>'));
          const n = document.createElement("button");
          ((n.type = "button"),
            (n.textContent = "✕"),
            (n.style.cssText =
  ...
  function hr() {
    S.netMonitorOn && S.netMonitorBadge
      ? (ur ||
          ...
          (ur.id = "ytp-net-badge"),
          (ur.title = "YT+ session network: ↓ down / ↑ up"),
          document.body && document.body.appendChild(ur)),
        ur &&
          a(
            ur,
            '<span class="ytp-net-badge-dn">↓ ' +
              or(Gn.sessionDown) +
              '</span><span class="ytp-net-badge-sep">·</span><span class="ytp-net-badge-up">↑ ' +
              or(Gn.sessionUp) +
              "</span>",
          ))
    ...
    apply(t) {
      S.netMonitorOn && !S.privacyShieldOn
        ? ((function () {
          ...
          hr(),
          t.addStyle(
            "#ytp-net-badge{position:fixed;bottom:8px;left:8px;z-index:2147483636;background:var(--yt-spec-menu-background,rgba(0,0,0,.82));border:1px solid var(--yt-spec-10-percent-layer,rgba(255,255,255,.12));border-radius:8px;padding:5px 10px;font:11px/1.3 ui-monospace,SFMono-Regular,Consolas,monospace;pointer-events:none;display:flex;gap:6px;align-items:center;color:var(--yt-spec-text-primary,#fff)}#ytp-net-badge .ytp-net-badge-dn{color:#4dd0e1}#ytp-net-badge .ytp-net-badge-up{color:#ff8a65}#ytp-net-badge .ytp-net-badge-sep{color:var(--yt-spec-text-secondary,#888)}body.ytp-silent #ytp-net-badge{display:none!important}",
          ),
          t.addInterval(() => {
            S.netMonitorBadge && hr();
          }, 3e3),
    ...
    settings(e) {
      ...
      const a = async () => {
        ...
        (o.appendChild(i("Total", or(n.total), n.reqs + " requests")),
          o.appendChild(i("↓ Downloaded", or(n.down))),
          o.appendChild(i("↑ Uploaded", or(n.up))),
          t.appendChild(o));
        ...
        if (
          ...
          (a.appendChild(To("span", "ytp-net-swatch ytp-net-swatch-dn")),
            a.appendChild(To("span", "ytp-net-legend-label", "↓ Download")));
          const n = To("span", "ytp-net-legend-item");
          (n.appendChild(To("span", "ytp-net-swatch ytp-net-swatch-up")),
            n.appendChild(To("span", "ytp-net-legend-label", "↑ Upload")),
            e.appendChild(a),
            e.appendChild(n),
            t.appendChild(e));
    ...
    xa.register({
      ...
      apply(e) {
        ...
        const n = () => {
          ...
          ((t.type = "button"),
            (t.className = "ytp-button ytp-plus-dash-btn"),
            (t.title = "Open YT+"),
    ...
    xa.register({
      ...
      apply(e) {
        ...
        const n = () => {
          ...
          const t = document.createElement("button");
          ((t.type = "button"),
            (t.className = "ytp-button ytp-extra-btn ytp-stop-btn"),
  ...
  function Cr(e, t, n, r) {
    ...
    ((i = document.createElement("button")),
      (i.type = "button"),
      (i.className = "ytp-button ytp-extra-btn " + e),
      (i.title = t),
  ...
  (xa.register({
    ...
    apply(t) {
      if ((zr(), Zr(), !S.themeEngineOn || "none" === S.themeSelected))
        return void (
          S.themeEngineOn &&
          S.themeOverhaulOn &&
    ...
    try {
      !(function () {
        if ("function" == typeof GM_registerMenuCommand) {
          try {
            GM_registerMenuCommand("Open YT+ (Alt+Y)", Uo);
          } catch (e) {}
          try {
          ...
          try {
            GM_registerMenuCommand(
              "Mark every video on this channel as watched",
              nn,
            );
          } catch (e) {}
          try {
            GM_registerMenuCommand("Turn SponsorBlock on or off", () =>
              Ta("sponsorblockOn", !S.sponsorblockOn),
            );
          } catch (e) {}
          try {
            GM_registerMenuCommand("Hide on-screen messages", () =>
              Ta("silentToasts", !S.silentToasts),
            );
          } catch (e) {}
          try {
          ...
          try {
            GM_registerMenuCommand(
              "Pop out the video (Picture-in-Picture)",
              Pa,
            );
          } catch (e) {}
          try {
            GM_registerMenuCommand("Take a screenshot of the video", Ia);
          } catch (e) {}
          try {
            GM_registerMenuCommand("Save my settings to a file", Go);
          } catch (e) {}
          try {
            (GM_registerMenuCommand("Turn YT+ off for this tab", () => {
              try {
                sessionStorage.setItem("ytplus_kill", "1");
              } catch (e) {}
              try {
                for (const e of va.keys()) ha(e);
              } catch (e) {}
              pe("YT+ is off for this tab. Reload to confirm.", 4e3, "info");
            }),
              GM_registerMenuCommand(
                "Turn YT+ off until I turn it back on",
                () => {
                  try {
                    localStorage.setItem("ytplus_killed", "1");
                  } catch (e) {}
                  pe(
                    "YT+ is now off. Add ?ytplus=on to the URL to turn it back on.",
                    5e3,
                    "info",
                  );
                },
              ...
              GM_registerMenuCommand(
                "Re-enable features that crashed earlier",
                () => {
                  (xa.clearQuarantine(),
                    pe(
                      "Crashed features are now allowed to try again.",
                      2200,
                      "success",
                    ));
                },
